...
const DepartureButton1Square = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <circle style={{ animation: 'var(--departure-animation, none)' }} fill="var(--color-departure, #121f1e)" cx={19.35} cy={37.5} r={4.94} />
    <circle fill="var(--detail-color, #6e6e6e)" cx={55.65} cy={37.5} r={10} />
    <circle fill="var(--main-color-alt, #b3b3b3)" cx={55.65} cy={37.5} r={8} />
    <circle style={{ animation: 'var(--shunt-animation, none)' }} fill="var(--color-shunt, #121f1e)" cx={55.65} cy={37.5} r={4.94} />
  </svg>
);
